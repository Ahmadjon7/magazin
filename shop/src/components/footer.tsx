...
const Footer = () => {
  return (
    ...
    <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        ...
        <p className="mt-2 text-sm text-gray-500">Air plant banjo lyft occupy retro adaptors indigo</p>
        </div>
    ...
    <div className="bg-gray-100 w-fulll">
        ...
        <p className="text-gray-500 text-sm text-center sm:text-left">© 2023 STOUT</p>
